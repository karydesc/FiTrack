...
class ListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
      ...
      child: ListTile(
        ...
        subtitle: Text('in Account: ${HiveService().getAccount(transaction.accountId)!.name}'),
        ...
        trailing: Text(
          ...
          style: TextStyle(
            ...
            color: transaction.type == 'incoming' ? const Color.fromARGB(255, 2, 138, 7) : const Color.fromARGB(255, 245, 72, 59),
          ),
        ),
        ),
      );
