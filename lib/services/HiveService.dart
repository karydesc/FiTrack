...
class HiveService {
  ...
  final Box<Transaction> _transactionsBox = Hive.box<Transaction>('transactionsBox');
  ...
  void deleteAccount(Account account){
    final Iterable<Transaction> toBeRemoved = _transactionsBox.values.where((element)=> element.accountId==account.id);
